...
def create_comment(request: schema.CommentRequest, database: Session = Depends(get_database)):
    """
...
def retrieve_all_db_comments(database: Session = Depends(get_database)):
    """
...
def retrieve_all_post_comments(post_id: int, database: Session = Depends(get_database)):
    """
...
def retrieve_comment(comment_id: int, database: Session = Depends(get_database)):
    """
...
def update_comment(comment_id: int, request: schema.CommentRequest, database: Session = Depends(get_database)):
    """
...
def delete_comment(comment_id: int, database: Session = Depends(get_database)):
    """
